...
module.exports.routes = {
  ...
  "get /getAllAffiliateForBrand": "UsersController.getAllAffiliateForBrand",
  "get /getAllBrandForAffiliate": "UsersController.getAllBrandForAffiliate",
  ...
  "get /subscribe/show-discount":
    "SubscriptionPlansController.showDiscountAtSubscribe",
  ...
  "post /transaction/download-invoice":
    "TransactionsController.downloadInvoice",
  ...
  "put /notification/change-status-all":
    "NotificationsController.ReadUnreadAll",
  ...
  "post /common-category/multiple":
    "CommonCategoryController.addMultipleCommonCategories",
  ...
  "get /sub-child-category":
    "SubChildCategoryController.getAllSubChildCommonCategory",
  ...
  "delete /sub-child-category":
    "SubChildCategoryController.deleteSubChildCommonCategory",
