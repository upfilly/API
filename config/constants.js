module.exports.constants = {
  user: {
    ...
    DELETED_ACCOUNT: "Account does not exist.",
  ...
  TRANSACTION: {
    ...
    ACCOUNT_NOT_CREATED:
      "Payment was unsuccessfull because user not added their bank on stripe.",
  ...
  CONTRACT: {
    ...
    ALREADY_EXIST: "Same name already exists",
    CANNOT_CHANGE_ACCEPTED:
      "Sorry, but you can't change status of completed contract",
  ...
  HIRING: {
    ...
    CANNOT_CANCEL:
      "Sorry but you can't change status of accepted or cancelled invites",
  ...
  PROFILE_CLAIM: {
    ...
    VERIFICATION_CODE_SENT:
      "Verification code sent to registered profile email successfully",
  ...
  COMMON_DELETES: {
    ...
    CANT_DELETE_RUNNING_CONTRACT:
      "Sorry, but you can't delete running contracts",
    INVALID_CAMPAIGN_ID: "Invalid campaign id",
    CANT_DELETE_RUNNING_CAMPAIGN:
      "Sorry, but you can only delete pending campaign",
  },
  CAMPAIGN: {
  ...
  POINTS: {
    ...
    REDEEMED_BUT_CREDIT_NOT_UPDATED:
      "Points redeemed successfully but credits not updated",
    REDEEMED_BUT_USER_NOT_FOUND:
      "Points redeemed but user not found to update credits",
  },
  REVIEWS: {
  ...
  SCRIPT: {
    ...
    NO_DEFAULT_SCRIPT : "No default script added",
  },
  BLOG: {
  ...
  PRODUCT: {
    ...
    PRODUCT_REQUEST_ALREADY_EXIST:
      "We're sorry, but it appears that your request has already been submitted. Duplicate requests are not allowed",
    REQUEST_SENT:
      "Your request has been sent successfully.Thank you for your submission!",
  ...
  AFFILIATELINK: {
    ...
    DELETED: "Affiliate link deleted successfully",
