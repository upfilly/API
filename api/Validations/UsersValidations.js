...
exports.register = async (req, res, next) => {
    ...
    const schema = Joi.object({
        ...
        company_registration_number: Joi.string().optional().allow("", null),
        company_url: Joi.string().optional().allow("", null),
        billing_email: Joi.string().optional().allow("", null),
        ...
        stripe_statement_descriptor: Joi.string().optional().allow("", null),
        company_email: Joi.string().optional().allow("", null),
        company_address: Joi.string().optional().allow("", null),
        company_country_code: Joi.string().optional().allow("", null),
        company_dial_code: Joi.string().optional().allow("", null),
        company_mobile_no: Joi.string().optional().allow("", null).min(5).max(12),
...
exports.editProfile = async (req, res, next) => {
    ...
    const schema = Joi.object({
        ...
        company_registration_number: Joi.string().optional().allow(""),
        company_url: Joi.string().optional().allow(""),
        billing_email: Joi.string().optional().allow(""),
        ...
        stripe_statement_descriptor: Joi.string().optional().allow(""),
        federal_text_classification: Joi.string().optional().valid("individual", "s_corporation", "c_corporation", "patnership", "limited_liability",),
        social_security_number: Joi.string().optional(),
        tax_classification: Joi.string().optional(),
        tax_name: Joi.string().optional(),
