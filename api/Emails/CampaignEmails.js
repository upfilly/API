...
exports.AddCampaign = async (options) => {
   ...
   <body style="font-family: sans-serif;">
    ...
    <p style="margin-bottom: 8px;color: #747474;font-size: 13px;    line-height: 18px; ">You have a new campaign request from <b>${get_brand.fullName}</b> brand.</p>
    <p style="margin-bottom: 8px;color: #747474;font-size: 13px;    line-height: 18px; ">To get started, Click on - <a href="${options.campaign_link}">${options.campaign_link}</a> and share it on your social media platforms.</a>
             ...
             <div style="
                ...
                <div style="text-align: center; margin-top: 30px;">
                   <p style="
                      ...
                      font-size: 20px;
                      font-style: normal;
                      font-weight: 100 !important;">Hi <b> ${get_affiliate.fullName} </b>,<br>
                ...
                <div style="text-align: center; 
                   ...
                   <p style="
                      ...
                      font-weight: 300;
                      line-height: 18px;">
                      You have a new request from ${get_brand.fullName} brand.
                   </p>
