...
exports.send_invite = async (options) => {
 ...
 border: none;
 color: #fff;
 padding: 10px 20px;border-radius: 30px;cursor: pointer;  "href=`+ credentials.FRONT_WEB_URL + "/signup/affiliate?referral_code=" + my_code + "&b_id=" + brand_id + `>Go to our website</a>
 </div>
