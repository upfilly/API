       ...
       <div style="text-align: center;">
           ...
           text-align: center;  display: -webkit-flex; border: 5px solid #00BAFF; background: #fff; margin: auto;  border-radius: 50%; display: flex; justify-content: center;align-items: center;">
               <div>
                ...
                <p style="margin-top: 0px;    font-size: 14px; color:#373737; margin-bottom: 0;">  You have an email template message from ${brandFullName} kindly check you account
                </p>
                </div>
                </div>
                </div>
...
`
   ...
   SmtpController.sendEmail(affiliateEmail, 'Recieved Email Template Message', message)
};