...
// `
 ...
 exports.reminderToOpenAccount = async (options) => {
          ...
          <div style="text-align: center;">
              ...
              text-align: center;  display: -webkit-flex; border: 5px solid #00BAFF; background: #fff; margin: auto;  border-radius: 50%; display: flex; justify-content: center;align-items: center;">
                  <div>
                   ...
                   <p style="margin-top: 0px;    font-size: 14px; color:#373737; margin-bottom: 0;">Kindly Create your bank account for receive payments from Admin.
                   </p>
                   </div>
                   </div>
                   </div>
   ...
   `
     ...
     SmtpController.sendEmail(email, 'Reminder To Open Account', message)
 };

 exports.adminPaid= async (options) => {
      ...
      <div style="text-align: center;">
          ...
          text-align: center;  display: -webkit-flex; border: 5px solid #00BAFF; background: #fff; margin: auto;  border-radius: 50%; display: flex; justify-content: center;align-items: center;">
              <div>
                       <img src="${credentials.BACK_WEB_URL}/images/upfilly.png"style="width:115px; height: 40px; object-fit: contain;">
               <h1 style="  margin-bottom: 0px;  margin-top: 10px; font-size: 18px;"><span style="font-weight: 400;color:#373737;">Hi </span>${fullName},</h1>
               <p style="margin-top: 0px;    font-size: 14px; color:#373737; margin-bottom: 0;">Congratulations! Admin has paid to you $ ${amount} 
               </p>
               </div>
               </div>
               </div>
...
`
 ...
 SmtpController.sendEmail(email, 'Commission Added', message)
};