...
exports.offerSent = async (options) => {
   ...
   <body style="font-family: sans-serif;">
        ...
        <div style="text-align: center;">
            ...
            text-align: center;  display: -webkit-flex; border: 5px solid #00BAFF; background: #fff; margin: auto;  border-radius: 50%; display: flex; justify-content: center;align-items: center;">
                <div>
                 ...
                 <p style="margin-top: 0px;    font-size: 14px; color:#373737; margin-bottom: 0;">This is an notification email to let you know about assign product request.
                 </p>
                 </div>
                 </div>
                 </div>
    ...
    <p style="margin-bottom: 8px;color: #747474;font-size: 13px;    line-height: 18px; ">You have a new request from <b>${get_brand.fullName}</b> brand.</p>
...
`
   SmtpController.sendEmail(email, 'Offer Request', message)
};
        ...
        <div style="text-align: center;">
            ...
            text-align: center;  display: -webkit-flex; border: 5px solid #00BAFF; background: #fff; margin: auto;  border-radius: 50%; display: flex; justify-content: center;align-items: center;">
                <div>
                 ...
                 <p style="margin-top: 0px;    font-size: 14px; color:#373737; margin-bottom: 0;">This is an notification email to let you know about Offer request.
                 </p>
                 </div>
                 </div>
                 </div>
