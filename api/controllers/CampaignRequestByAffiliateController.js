...
exports.sendCampaignRequestToBrand = async (req, res) => {
    try {
        ...
        if(campaign && campaign.campaign_type != "manual"){
            return response.failed(null, constants.CAMPAIGN_REQUEST_BY_AFFILIATE.MANUAL_REQUIRED, req, res);
        }
        let request_query = {
