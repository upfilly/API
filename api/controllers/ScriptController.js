...
exports.addScript = async (req, res) => {
  try {
    let validation_result = await Validations.ScriptValidations.addScript(
      req,
      res
    );
  ...
  try {
    ...
    let projection = {
      $project: {
        ...
        brand_id: "$brand_id",
        brand_id_details: {
          firstName: "$brand_id_details.firstName",
          lastName: "$brand_id_details.lastName",
          fullName: "$brand_id_details.fullName",
          email: "$brand_id_details.email",
        },
        isDefault: "$isDefault",
        createdAt: "$createdAt",
        updatedAt: "$updatedAt",
